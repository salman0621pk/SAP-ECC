...
TABLES: ZEBIZ_MATRIX, ZEBIZ_CUSTOMER , KNA1, ADR6, TCURT.
...
*              CONCATENATE  ZEBIZ_CUSTOMER-EXPDATE+0(4) '-' ZEBIZ_CUSTOMER-EXPDATE+4(2) INTO EDATE.
*              CONCATENATE  LV_DATE(4) '-' LV_DATE+4(2) '-' LV_DATE+6(2) INTO GDATE.
